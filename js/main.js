              ...
              bubblesConfig: {
                  ...
                  popupTemplate: function(geography, data) {
                    if (colors[data.fillKey].length > 2) {
                      ...
                      return `<div class="hoverinf"> <div class="image" style="height: 175px; width: 150px; background-image: url(${`https://source.unsplash.com/150x175/?${data.fillKey}`})"></div><div class="bottombar"><div class="hexc" style="display: flex; align-items: center; justify-content: center"><div class="hex" style="border: 1px solid black; background-color: ${colors[data.fillKey][0]}; height: 25px; width: 25px"></div> <div class="hex" style="background-color: ${colors[data.fillKey][1]}; height: 25px; width: 25px"></div><div class="hex" style="background-color: ${colors[data.fillKey][2]}; height: 25px; width: 25px"></div></div> <div class="title">${data.city}</div> </div></div>`
                    } else {
                      console.log(colors[data.fillKey]);
                      return `<div class="hoverinf"> <div class="image" style="background-image: url(${`https://source.unsplash.com/150x175/?${data.fillKey}`}); height: 175px; width: 150px"></div> <div class="title">${data.city}</div> <div class="bottombar"><div class="hexc" style="display: flex; align-items: center; justify-content: center"><div class="hex" style="background-color: ${colors[data.fillKey][0]}; height: 25px; width: 25px"></div> <div class="hex" style="background-color: ${colors[data.fillKey][1]}; height: 25px; width: 25px"></div></div></div>`
                    }
                  },
                  fillOpacity: 1,
                  animate: true,
