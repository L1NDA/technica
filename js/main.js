...
var bubble_map = new Datamap({
            ...
            fills: {
                ...
                chicago: 'url(#chicagosolid)',
                houston: 'url(#houstonsolid)',
                philadelphia: 'url(#philadelphiasolid)',
                phoenix: 'url(#phoenixsolid)',
                sanantonio: 'url(#sanantoniosolid)',
                sandiego: 'url(#sandiegosolid)',
